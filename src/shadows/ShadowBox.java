...
public class ShadowBox {
	...
	public static final float SHADOW_DISTANCE = 50f;
	...
	private Matrix4f calculateCameraRotationMatrix() {
		...
		rotation.rotate((float) Math.toRadians(-cam.rotation.z), new Vector3f(0, 1, 0));
		rotation.rotate((float) Math.toRadians(-cam.rotation.x), new Vector3f(1, 0, 0));
		return rotation;
	}
